...
// WorkerHPABuilder builds HPA for Wazuh Manager Workers
type WorkerHPABuilder struct {
	clusterName string
	namespace   string
...
// NewWorkerHPABuilder creates a new WorkerHPABuilder
func NewWorkerHPABuilder(clusterName, namespace string) *WorkerHPABuilder {
	return &WorkerHPABuilder{
...
func (b *WorkerHPABuilder) WithSpec(spec *wazuhv1.HPASpec) *WorkerHPABuilder {
	b.spec = spec
	return b
}

// WithLabels sets additional labels
func (b *WorkerHPABuilder) WithLabels(labels map[string]string) *WorkerHPABuilder {
...
func (b *WorkerHPABuilder) WithAnnotations(annotations map[string]string) *WorkerHPABuilder {
...
// Build creates the HPA resource for Worker StatefulSet
func (b *WorkerHPABuilder) Build() *autoscalingv2.HorizontalPodAutoscaler {
	if b.spec == nil || !b.spec.Enabled {
		return nil
	}

	name := b.clusterName + "-manager-worker"
...
func (b *WorkerHPABuilder) buildBehavior() *autoscalingv2.HorizontalPodAutoscalerBehavior {
	if b.spec.Behavior == nil {
		return nil
	}
...
func (b *WorkerHPABuilder) buildScalingRules(rules *wazuhv1.HPAScalingRules) *autoscalingv2.HPAScalingRules {
	if rules == nil {
		return nil
	}
...
func (b *WorkerHPABuilder) GetName() string {
	return b.clusterName + "-manager-worker"
}
