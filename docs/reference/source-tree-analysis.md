...
```text
wazuh-operator/
├── api/v1/                                        # CRD Type Definitions - v1 Storage Version (28 files)
...
│   ├── opensearch_shared_types.go                 # Shared OpenSearch types (ClusterSettings, WazuhPluginConfig)
...
│   │   │   ├── manager_reconciler.go              # Manager struct (used by cluster reconciler)
...
│
├── controllers/                                   # Kubernetes Controllers (21 files)
...
│   │   └── *.yaml                                 # 21 CRD manifests (generated by controller-gen)
