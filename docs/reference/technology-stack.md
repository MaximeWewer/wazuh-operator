...
- **Custom Resource Definitions (CRDs)**: 27 CRDs for declarative resource management
  ...
  - Wazuh Config: WazuhRule, WazuhDecoder, WazuhCDBList, WazuhActiveResponse, WazuhIntegration, WazuhCertificate, WazuhFilebeat, WazuhAgentGroup
...
2. **Controller Layer** (`controllers/`): Reconciliation logic (27 controllers)
