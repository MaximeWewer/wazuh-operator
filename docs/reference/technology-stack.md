...
- **Custom Resource Definitions (CRDs)**: 22 CRDs for declarative resource management

  - Wazuh Core: WazuhCluster
  - Wazuh Config: WazuhRule, WazuhDecoder, WazuhCertificate, WazuhFilebeat, WazuhAgentGroup
...
2. **Controller Layer** (`controllers/`): Reconciliation logic (22 controllers)
