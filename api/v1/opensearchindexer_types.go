...
// ClusterSettingsSpec defines OpenSearch cluster-level settings applied via the Cluster Settings API
...
type OpenSearchIndexerStatus struct {
	...
	// AppliedSettingsHash is the hash of successfully applied cluster settings
